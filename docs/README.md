...
| [Providers](providers.md) | Multi-provider routing, per-agent models, file-based executors |
| [Agent Contract](agent-contract.md) | Capability schema: tool grants, write scope, resource ceilings |
| [Governance](governance.md) | What agents can and cannot edit during runs |

For maintainers: [RELEASING.md](../RELEASING.md) · [CONTRIBUTING.md](../CONTRIBUTING.md) · [SECURITY.md](../SECURITY.md)
